...
| **P22** | Que las cascadas apunten al centro de lo que se ve en vez de al origen del mundo. Parche barato mientras no exista P21: la sombra al menos cae donde estás mirando en una escena no centrada en (0,0,0). Sigue siendo paralela, así que NO arregla la luz de punto. | `Passes/ShadowPass.cpp:441` y `D3D12Renderer.cpp:9121`, en la rama de punto/foco. | **PropertiesPanel**, sección Light: el tooltip del aviso deja de decir «solo cuadra con la escena centrada en el origen». | Medio: cambia dónde cae la sombra en escenas que hoy funcionan por estar centradas en el origen. | S |
