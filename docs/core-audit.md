...
**H12 y H13 se descartaron por medición** (P4 y P5), sin tocar producción.
**Quedan 16 abiertas**, todas Media o Baja.
...
>
> **Lo que queda abierto: 16 filas** (H2 reducido incluido), todas Media o
> Baja, y ninguna con un caso de uso que empuje. Las que quedan son de
> contrato y de diagnóstico —H3, H4, H5, H6, H7, H8, H9, H10, H11, H16, H17,
> H20, H21— más las dos de arquitectura (H18/P6, H19), que son L y no
> arreglan ningún fallo.
