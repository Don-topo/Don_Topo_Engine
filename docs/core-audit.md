...
>
> **Lo que queda abierto: 14 filas** (H2 reducido incluido), todas Media o
> Baja. Las que quedan son de contrato y de diagnóstico —H4, H5, H6, H7, H8,
> H9, H10, H11, H16, H17, H20, H21—, ninguna con un caso de uso que empuje,
> más **H19**, que es la única que ha ganado peso: tocar una cabecera de cien
> líneas cuesta **266 s**, más que reconstruirlo todo desde cero (223 s). Ya no
> es "falta un problema concreto que lo pague"; el problema está medido y hay
> una vía más barata que la que la fila proponía.
